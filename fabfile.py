...
from fabric.contrib.files import exists,upload_templete
from fabric.decorators import task

env.roledefs = {
    'myserver':['wuyizhen@127.0.0.1']
}
env.PROJECT_NAME = 'typeidea'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'

env.DEPLOY_PATH = '/home/wuyizhen/venvs/typeidea-env'
...
def deploy(version,profile):
    ...
    with prefix('source %s' % env.VENV_AVTIVATE):
